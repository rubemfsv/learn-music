...
mixin _$QuestCategoryStore on _QuestCategoryStore, Store {
  Computed<List<QuestCategory>> _$visibleCategoriesComputed;

  @override
  List<QuestCategory> get visibleCategories => (_$visibleCategoriesComputed ??=
          Computed<List<QuestCategory>>(() => super.visibleCategories,
              name: '_QuestCategoryStore.visibleCategories'))
      .value;
